...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		"`EVENTS`.`id`" => "id",
		"`EVENTS`.`teams`" => "teams",
		"if(`EVENTS`.`date`,date_format(`EVENTS`.`date`,'%m/%d/%Y %h:%i %p'),'')" => "date",
		"TIME_FORMAT(`EVENTS`.`endtime`, '%r')" => "endtime",
		"`EVENTS`.`seats`" => "seats"
	);
	...
	$x->TableTitle = "Events";
	$x->TableIcon = "resources/table_icons/calendar_edit.png";
	$x->PrimaryKey = "`EVENTS`.`id`";

	$x->ColWidth   = array(  150, 150, 150, 150);
	$x->ColCaption = array("Teams", "Date", "Endtime", "Seats");
	$x->ColFieldName = array('teams', 'date', 'endtime', 'seats');
