	...
	$lookups = array(   
		...
		'BOOK' => array(   
			'teams' => array(
				'parent_table' => 'EVENTS',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`EVENTS`.`teams`) || CHAR_LENGTH(if(`EVENTS`.`date`,date_format(`EVENTS`.`date`,\'%m/%d/%Y %h:%i %p\'),\'\')), CONCAT_WS(\'\', `EVENTS`.`teams`, \'>>\', if(`EVENTS`.`date`,date_format(`EVENTS`.`date`,\'%m/%d/%Y %h:%i %p\'),\'\')), \'\')',
				'parent_from' => '`EVENTS` ',
				'filterers' => array(),
				'custom_query' => '',
			...
			'mode' => array(
				...
				'parent_pk_field' => 'id',
				'parent_caption' => '`payments`.`channels`',
				'parent_from' => '`payments` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'paypal' => array(
				'parent_table' => 'payments',
				'parent_pk_field' => 'id',
				'parent_caption' => '`payments`.`paypal`',
				'parent_from' => '`payments` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
