<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'BOOKING' table. 
	...
	*/
	...
	function BOOKING_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function BOOKING_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function BOOKING_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['Teams'], $data['venue'], $data['date'], $data['endtime'], $data['slots']
	...
	*/
	...
	function BOOKING_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function BOOKING_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['Teams'], $data['venue'], $data['date'], $data['endtime'], $data['slots']
	...
	*/
	...
	function BOOKING_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function BOOKING_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function BOOKING_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function BOOKING_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function BOOKING_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function BOOKING_batch_actions(&$args){
