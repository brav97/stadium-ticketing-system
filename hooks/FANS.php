<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'FANS' table. 
	...
	*/
	...
	function FANS_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function FANS_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function FANS_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['Name'], $data['phone'], $data['id_no']
	...
	*/
	...
	function FANS_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function FANS_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['ID'], $data['Name'], $data['phone'], $data['id_no']
	...
	*/
	...
	function FANS_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function FANS_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function FANS_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function FANS_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function FANS_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function FANS_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function FANS_batch_actions(&$args){
