<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'RESERVE' table. 
	...
	*/
	...
	function RESERVE_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function RESERVE_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function RESERVE_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['Event'], $data['assigned_to'], $data['time'], $data['status'], $data['Amount_paid'], $data['mode']
	...
	*/
	...
	function RESERVE_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function RESERVE_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['Event'], $data['assigned_to'], $data['time'], $data['status'], $data['Amount_paid'], $data['mode']
	...
	*/
	...
	function RESERVE_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function RESERVE_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function RESERVE_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function RESERVE_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function RESERVE_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function RESERVE_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function RESERVE_batch_actions(&$args){
