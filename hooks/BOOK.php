<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'BOOK' table. 
	...
	*/
	...
	function BOOK_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function BOOK_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function BOOK_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['Event'], $data['tickets'], $data['id_no'], $data['others'], $data['phone'], $data['name'], $data['mode']
	...
	*/
	...
	function BOOK_before_insert(&$data, $memberInfo, &$args){

		

		$eventID=$data['teams'];
$getSeatsAvailable=sqlValue("SELECT seats FROM events WHERE id='$eventID'");
$checkBookings=sqlValue("SELECT COUNT(*) FROM book WHERE teams='$eventID'");
if($checkBookings<=$getSeatsAvailable) {
return TRUE; 
}
else{
echo error_message("Sorry !stadium full");
exit; 
}
	...
	*/
	...
	function BOOK_after_insert($data, $memberInfo, &$args){

		return TRUE;
	}
	

	function BOOK_before_update(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['ID'], $data['Event'], $data['tickets'], $data['id_no'], $data['others'], $data['phone'], $data['name'], $data['mode']
	...
	*/
	...
	function BOOK_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function BOOK_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function BOOK_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function BOOK_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function BOOK_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function BOOK_batch_actions(&$args){
