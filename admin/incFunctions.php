	...
	function get_tables_info($skip_authentication = false){
		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				'EVENTS' => array(
					'Caption' => 'Events',
					'Description' => 'Add/edit/delet events  from this tab',
					'tableIcon' => 'resources/table_icons/calendar_edit.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'BOOK' => array(
					'Caption' => 'BOOK',
					'Description' => 'Book a ticket From this tab',
					'tableIcon' => 'resources/table_icons/book_edit.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'RESERVE' => array(
					'Caption' => 'RESERVE TICKETS',
					'Description' => 'Adding of tickets manually ',
					'tableIcon' => 'resources/table_icons/note_add.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'FANS' => array(
					...
					'tableIcon' => 'resources/table_icons/teamwork.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'payments' => array(
					'Caption' => 'Payment channels',
					'Description' => 'add your payment channels here',
					'tableIcon' => 'resources/table_icons/money.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				)
		);
