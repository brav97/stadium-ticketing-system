	...
	*/
	...
	$schema = array(   
		'EVENTS' => array(   
			...
			'teams' => array('appgini' => 'VARCHAR(40) null '),
			'date' => array('appgini' => 'DATETIME null default \'1\' '),
			'endtime' => array('appgini' => 'TIME null '),
			'seats' => array('appgini' => 'INT null ')
		),
		'BOOK' => array(   
			'ID' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'teams' => array('appgini' => 'INT unsigned null '),
			'id_no' => array('appgini' => 'INT unsigned null '),
			'phone' => array('appgini' => 'INT unsigned null '),
			'name' => array('appgini' => 'INT unsigned null '),
			'mode' => array('appgini' => 'INT unsigned null '),
			'mpesa' => array('appgini' => 'INT unsigned null '),
			'paypal' => array('appgini' => 'INT unsigned null '),
			'bank' => array('appgini' => 'INT unsigned null '),
			'select' => array('appgini' => 'VARCHAR(40) null '),
			'enters' => array('appgini' => 'VARCHAR(40) null '),
			'book_date' => array('appgini' => 'DATETIME null default \'1\' ')
		),
		'RESERVE' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'Event' => array('appgini' => 'INT unsigned null '),
			'assigned_to' => array('appgini' => 'VARCHAR(40) null '),
			'time' => array('appgini' => 'TIME null '),
			'status' => array('appgini' => 'VARCHAR(40) null '),
			'Amount_paid' => array('appgini' => 'VARCHAR(40) null '),
			'mode' => array('appgini' => 'VARCHAR(40) null ')
		),
		'FANS' => array(   
			'ID' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'Name' => array('appgini' => 'VARCHAR(40) null '),
			'phone' => array('appgini' => 'INT null '),
			'id_no' => array('appgini' => 'INT null ')
		),
		'payments' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'channels' => array('appgini' => 'VARCHAR(40) null '),
			'mpesa' => array('appgini' => 'VARCHAR(40) null '),
			'paypal' => array('appgini' => 'VARCHAR(40) null '),
			'bank' => array('appgini' => 'VARCHAR(40) null ')
		)
	);
